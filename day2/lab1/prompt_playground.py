...
def validate_controls(temperature: float, max_output_tokens: int) -> None:
    """Validate user controls; raise ValueError on invalid input."""
    # TODO: write your code here
    # Requirements:
...
def build_generate_payload(
    *,
    ...
    """Build the JSON payload for a non-streaming /api/generate request."""
    # TODO: write your code here
    # Requirements:
    # - Must set stream=False
    # - Must set options.temperature and options.num_predict
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Day 2 Lab 1: prompt controls playground (Ollama)"
    )
